        ...
        <ul class="clear_float">
          ...
          <li v-if="editBoxData.Type==81||editBoxData.Type==83?false:true">
            ...
            <el-select
              ...
              :disabled="singleCarrierProductForbid"
              class="green24x13"
            >
              <el-option label="是" :value="true"></el-option>
              <el-option label="否" :value="false"></el-option>
          ...
          <li v-if="editBoxData.Type==81||editBoxData.Type==83?false:true">
            ...
            <el-select
              ...
              :disabled="forbid||singleCarrierProductForbid"
              class="green24x13"
            >
              <el-option label="是" :value="true"></el-option>
              <el-option label="否" :value="false"></el-option>
...
export default {
  ...
  created() {
    ...
    axios({ url: `/api/Product/EditProductData/${this.editBoxData.Id}` })
      .then(res => {
        if (res.data.Code == 200) {
          ...
          if (this.editBoxData.Type == 81) {
            //外来器械关联生产商
            axios({ url: "/api/Supplier/ByType/1" })
              .then(res => {
                if (res.data.Code == 200) {
