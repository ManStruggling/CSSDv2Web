  ...
  <div class="basic_main" id="managementHome">
    <ul class="desktop_box">
        ...
        <div class="li_content">
          <ol>
            <li>
              ...
              <p class="progress_p">
                <el-progress :percentage="countPercentage('RecycleTaskForConsole')"></el-progress>
              </p>
            </li>
            <li>
              ...
              <p class="progress_p">
                <el-progress :percentage="countPercentage('CleanTaskForConsole')"></el-progress>
              </p>
            </li>
            <li>
              <p class="p_name">配包</p>
              ...
              <p class="progress_p">
                <el-progress :percentage="countPercentage('PackageTaskForConsole')"></el-progress>
              </p>
            </li>
            <li>
              <p class="p_name">灭菌</p>
              ...
              <p class="progress_p">
                <el-progress :percentage="countPercentage('SterilizeTaskForConsole')"></el-progress>
              </p>
            </li>
            <li>
              <p class="p_name">发放</p>
              ...
              <p class="progress_p">
                <el-progress :percentage="countPercentage('ProvideTaskForConsole')"></el-progress>
              </p>
            </li>
          </ol>
        </div>
      ...
      <li class="desktop_box_li desktop_box_lix480">
        ...
        <div class="li_content">
          <ol>
            <li><p class="p_name">XXXX科室</p><p class="p_name">骨穿包</p><p>4个</p><p>5天</p></li>
            <li><p class="p_name">XXXX科室</p><p class="p_name">骨穿包</p><p>4个</p><p>5天</p></li>
            <li><p class="p_name">XXXX科室</p><p class="p_name">骨穿包</p><p>4个</p><p>5天</p></li>
            <li><p class="p_name">XXXX科室</p><p class="p_name">骨穿包</p><p>4个</p><p>5天</p></li>
            <li><p class="p_name">XXXX科室</p><p class="p_name">骨穿包</p><p>4个</p><p>5天</p></li>
      ...
      <li class="desktop_box_li desktop_box_lix480">
        ...
        <div class="li_content">
          <div class="empty_data" v-show="expiringPackageList.length==0">暂无数据</div>
          <ol>
            <li
              v-for="(item,index) in expiringPackageList"
              :key="index"
            ><p class="p_name">{{item.SubClinicName}}</p><p class="p_name">{{item.ProductName}}</p><p>{{item.ExpiringCount}}个</p><p>{{item.RemainExpiringDays}}天</p></li>
          </ol>
          <el-pagination
            background
            layout="prev, pager, next"
            v-show="expiringPackageList.length"
            :total="Math.ceil(expiringPackageList.length / pageSize)*10"
...
export default {
        ...
        series: [
          {
            ...
            center: ["50%", "50%"],
            data: [
              { value: 400, name: "搜索引擎", itemStyle: { color: "#FF3948" } },
              { value: 335, name: "直接访问", itemStyle: { color: "#FF7533" } },
              { value: 310, name: "邮件营销", itemStyle: { color: "#FFB749" } },
              { value: 274, name: "联盟广告", itemStyle: { color: "#FFDC49" } },
              { value: 235, name: "视频广告", itemStyle: { color: "#96E842" } }
            ].sort(function(a, b) {
  ...
  created() {
    ...
    axios({url:`/api/MainConsole/Desktop`}).then(res=>{
  ...
  computed: {
    ...
    setProgressData(){
      return (origin)=>{
        if(this.desktopData.TaskSchedule[origin].length!=0){
          let arr = this.desktopData.TaskSchedule[origin].filter(val=>{return val.CssdId===this.GLOBAL.UserInfo.ClinicId});
          if(arr.length!=0){
    ...
    countPercentage(){
      return (origin)=>{
        if(this.desktopData.TaskSchedule[origin].length!=0){
          ...
          let arr = this.desktopData.TaskSchedule[origin].filter(val=>{return val.CssdId===this.GLOBAL.UserInfo.ClinicId});
          if(arr.length!=0){
            return parseInt((arr[0].AlreadyCompleteCount/arr[0].ShouldCompletedCount)*100);
          }else{
            return 0;
          }
        }else{
...
#managementHome {
  ...
  ul.desktop_box {
    ...
    .desktop_box_li {
      ...
      // #878D9F
      .el-pagination{
        .btn-quickprev,.btn-quicknext,.number,.btn-prev,.btn-next{
          background: #fff;
