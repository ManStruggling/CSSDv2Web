      ...
      >
        ...
        >
          <template slot-scope="props">
            <el-popover
              placement="right"
              :disabled="props.row.Periods[index].PeriodId==0"
              trigger="hover"
              :open-delay="1500"
            ...
            >
              ...
              <div
                slot="reference"
                class="periodItem"
                :class="{'is-cell-active':props.row.Periods[index].IsCellActive,'is-checked':props.row.Periods[index].IsCheckIn}"
                @click="tableCellClick(props.row.Periods[index])"
