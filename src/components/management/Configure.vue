    ...
    <div class="cssd_table_center cssd_totalBar">
        <div class="table_box">
            <ul>
                <li>
                    <p>重置锅次时间</p>
                    <el-time-picker :editable="false" :clearable="false" v-model="setData.ResetDeviceBatchTime" :value-format="'HH:mm'" :picker-options="{
                ...
                <li>
                    <p>提前预警天数</p>
                    <el-input-number v-model="setData.EarlyWarningDay" :min="1" :controls="false" @change="((newValue,oldValue)=>{handleNumberChange(newValue,oldValue,'EarlyWarningDay')})"></el-input-number>
                </li>
                <li>
                    <p>启用计数包</p>
                    <div class="switch_box">
                        <el-switch v-model="setData.IsActiveNotBarCodeProduct" active-color="#01BF6A" inactive-color="#dbdde6" :active-value="true" :inactive-value="false"></el-switch>
                    </div>
                </li>
                <li>
                    <p>启用个数包</p>
                    <div class="switch_box">
                        <el-switch v-model="setData.IsActiveNumberProduct" active-color="#01BF6A" inactive-color="#dbdde6" :active-value="true" :inactive-value="false"></el-switch>
                    </div>
                </li>
                <li>
                    <p>启用任务通知</p>
                    <div class="switch_box">
                        <el-switch v-model="setData.IsActiveNewTaskNotification" active-color="#01BF6A" inactive-color="#dbdde6" :active-value="true" :inactive-value="false"></el-switch>
                    </div>
                </li>
                <li>
                    <p>代销包控制</p>
            ...
            <ul>
                <li class="img_upload">
                    ...
                    <div class="img_box">
                        ...
                        <el-upload action="" list-type="picture-card" :auto-upload="false" :on-change="handleFileChange" :multiple="false" :limit="1" accept=".jpg, .jpeg, .png" :on-exceed="handleFileExceed">
