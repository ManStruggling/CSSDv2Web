...
<div id="cssd_table" class="cssd_home">
    ...
    <div class="cssd_index">
        ...
        <dl v-if="GLOBAL.UserInfo.ClinicType===1">
            ...
            <dd>
                <ul>
                    <router-link to="/outerPackage/Registration" v-if="GLOBAL.UserInfo.JobAndCompetence.includes('111')||GLOBAL.UserInfo.JobAndCompetence.includes('112')||GLOBAL.UserInfo.JobAndCompetence.includes('000')||GLOBAL.UserInfo.JobAndCompetence.includes('100')||GLOBAL.UserInfo.JobAndCompetence.includes('102')">
                        <li>
                    ...
                    <router-link to="/recovery/registration" v-if="GLOBAL.UserInfo.JobAndCompetence.includes('111')||GLOBAL.UserInfo.JobAndCompetence.includes('112')||GLOBAL.UserInfo.JobAndCompetence.includes('000')||GLOBAL.UserInfo.JobAndCompetence.includes('100')||GLOBAL.UserInfo.JobAndCompetence.includes('102')">
                        <li>
                            <p class="cssd_index_recycle"></p>
                            <span>回收</span>
                        </li>
                    </router-link>
                    <router-link to="/clean/select" v-if="GLOBAL.UserInfo.JobAndCompetence.includes('121')||GLOBAL.UserInfo.JobAndCompetence.includes('122')||GLOBAL.UserInfo.JobAndCompetence.includes('000')||GLOBAL.UserInfo.JobAndCompetence.includes('100')||GLOBAL.UserInfo.JobAndCompetence.includes('102')">
                        <li>
                            <p class="cssd_index_clean"></p>
                            <span>清洗消毒</span>
                        </li>
                    </router-link>
                    <router-link to="/package/taskList" v-if="GLOBAL.UserInfo.JobAndCompetence.includes('131')||GLOBAL.UserInfo.JobAndCompetence.includes('132')||GLOBAL.UserInfo.JobAndCompetence.includes('000')||GLOBAL.UserInfo.JobAndCompetence.includes('100')||GLOBAL.UserInfo.JobAndCompetence.includes('102')">
                        <li>
                            <p class="cssd_index_package"></p>
                            <span>配包</span>
                        </li>
                    </router-link>
                    <router-link to="/sterilize/select" v-if="GLOBAL.UserInfo.JobAndCompetence.includes('141')||GLOBAL.UserInfo.JobAndCompetence.includes('142')||GLOBAL.UserInfo.JobAndCompetence.includes('000')||GLOBAL.UserInfo.JobAndCompetence.includes('100')||GLOBAL.UserInfo.JobAndCompetence.includes('102')">
                        <li>
                            <p class="cssd_index_sterilize"></p>
                            <span>灭菌</span>
                        </li>
                    </router-link>
                    <router-link to="/provide/registration" v-if="GLOBAL.UserInfo.JobAndCompetence.includes('151')||GLOBAL.UserInfo.JobAndCompetence.includes('152')||GLOBAL.UserInfo.JobAndCompetence.includes('000')||GLOBAL.UserInfo.JobAndCompetence.includes('100')||GLOBAL.UserInfo.JobAndCompetence.includes('102')">
                        <li>
                            <p class="cssd_index_provide"></p>
                            <span>发放</span>
                        </li>
                    </router-link>
                    <router-link to="/provide/reserveCheck" v-if="GLOBAL.UserInfo.JobAndCompetence.includes('151')||GLOBAL.UserInfo.JobAndCompetence.includes('152')||GLOBAL.UserInfo.JobAndCompetence.includes('000')||GLOBAL.UserInfo.JobAndCompetence.includes('100')||GLOBAL.UserInfo.JobAndCompetence.includes('102')">
                        <li>
        ...
        <dl v-if="GLOBAL.UserInfo.ClinicType===2||GLOBAL.UserInfo.ClinicType===3" v-show="GLOBAL.UserInfo.JobAndCompetence.includes('272')||GLOBAL.UserInfo.JobAndCompetence.includes('271')||GLOBAL.UserInfo.JobAndCompetence.includes('000')||GLOBAL.UserInfo.JobAndCompetence.includes('200')||GLOBAL.UserInfo.JobAndCompetence.includes('202')">
            <dt>临床医疗科室</dt>
            <dd>
                <ul>
                    <router-link to="/apply/unqualifiedPackageRegistration">
                        <li>
                            <p class="cssd_index_unqualified"></p>
                            <span>不合格包登记</span>
                        </li>
                    </router-link>
                    <router-link to="/apply/registration">
                        <li>
        ...
        <dl v-if="GLOBAL.UserInfo.JobAndCompetence.includes('161')||GLOBAL.UserInfo.JobAndCompetence.includes('162')||GLOBAL.UserInfo.JobAndCompetence.includes('261')||GLOBAL.UserInfo.JobAndCompetence.includes('262')||GLOBAL.UserInfo.JobAndCompetence.includes('000')||GLOBAL.UserInfo.JobAndCompetence.includes('100')||GLOBAL.UserInfo.JobAndCompetence.includes('200')||GLOBAL.UserInfo.JobAndCompetence.includes('202')">
            ...
            <dd>
                <ul>
                    ...
                    <router-link to="/apply/putInInventory" v-if="GLOBAL.UserInfo.ClinicType===2||GLOBAL.UserInfo.ClinicType===3" v-show="GLOBAL.UserInfo.JobAndCompetence.includes('262')||GLOBAL.UserInfo.JobAndCompetence.includes('261')||GLOBAL.UserInfo.JobAndCompetence.includes('200')||GLOBAL.UserInfo.JobAndCompetence.includes('000')||GLOBAL.UserInfo.JobAndCompetence.includes('202')">
                        <li>
