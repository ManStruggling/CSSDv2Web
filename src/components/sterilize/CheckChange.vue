    ...
    <div class="cssd_table_center cssd_totalBar">
        <div class="tab_content">
            ...
            <ul class="clear_float">
                <li>
                    <p>质量检测类型</p>
                    <el-select v-model="data.ReviewType" class="green24x13" @change="reviewClassChange" :disabled="!data.HasBiologicalTest">
                ...
                <li>
                    ...
                    <el-select v-model="data[data.ReviewType]" class="green24x13" :disabled="data.ReviewType=='ChemicalReviewStatus'||guideData.BiologicalReviewStatus==2||guideData.BiologicalReviewStatus==3?true:false">
        ...
        <!-- 手工录入 -->
        <ManualEnter v-if="isShowManualEnter" @to-father="packageData2father" :mode="1" :ApiUrl="'/api/Scanner/SterilizeReady'" :BarCodeList="data.SterilizeFailedPackages"></ManualEnter>
    </div>
</div>
</template>
