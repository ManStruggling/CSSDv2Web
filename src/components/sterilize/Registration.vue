  ...
  <div class="cssd_box tabs_half_bar" id="sterilizeRegistration">
    <div class="cssd_title">
      <ul class="cssd_menu">
        ...
        <li @click="substitution" v-if="!UserInfo.Configuration.IsProxyProductPrintBarCode">
          <p>代消包登记</p>
        </li>
      </ul>
      <div class="cssd_title_right">
        ...
        <p class="biologicalTest">
          ...
          <b>
            <el-switch
              v-model="submitData.IsBiologicalTest"
              active-color="#01BF6A"
    ...
    <div
      :class="{cssd_table_center:true, cssd_totalBar:true, table_unExpand:true,displayNav:displayNav}"
    >
      <div class="cssd_table_left">
        <div class="cssd_talbe_left_menu">
          ...
          <el-tabs
            v-if="submitData.NotInCarrierPackages.length==0?false:true"
            :tab-position="'left'"
            :activeName="activeNameNotCarriersPackage"
            @tab-click="notCarrierTabClick"
          >
            <el-tab-pane>
              <div slot="label" class="tab_title">
                <p>无网篮包</p>
    ...
    >
      ...
      <ManualEnter
        ...
        :ApiUrl="'/api/Scanner/Sterilize'"
        :BarCodeList="submitData.Carriers.concat(submitData.NotInCarrierPackages)"
      ></ManualEnter>
    </transition>
    <transition
      name="fade"
