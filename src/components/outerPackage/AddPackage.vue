      ...
      <div class="container">
        <ul>
          ...
          <li>
            ...
            <el-input
              v-model.trim="outerPackageVm.CarrierName"
              @blur="getCarrierData(outerPackageVm.CarrierName)"
              placeholder="清洗架(必填)"
              :disabled="mode"
            ></el-input>
          </li>
        ...
        <ul>
          ...
          <li v-if="UserInfo.HospitalVersion=='TONGJI'">
  ...
  methods: {
    ...
    boxNumbersConfirm() {
      if (
        ...
        this.outerPackageVm.BoxNumbers = JSON.parse(
          JSON.stringify(this.boxList)
        );
