...
<div class="cssd_box" id="outerPackageRegistration">
    <div class="cssd_title">
        ...
        <div class="cssd_title_right">
            <p>备用包登记</p>
            <el-switch v-model="submitData.IsBackupPackage" active-color="#01BF6A" inactive-color="#dbdde6" :active-value="true" :inactive-value="false" :disabled="outerPackageChangeMode" @change="switchChange"></el-switch>
        </div>
    </div>
    <div class="cssd_table_center cssd_totalBar">
        <div class="table_box">
                ...
                <ul v-if="!submitData.IsBackupPackage">
                    <li>
                        ...
                        <div class="el_input_box font16blod">
                            <el-input v-model.trim="submitData.Patient.HospitalId" :disabled="true" class="font16blod" placeholder="住院号(必填)"></el-input>
                        </div>
                    </li>
                    <li>
                        <p class="font16gray">床号</p>
                        <div class="el_input_box font16blod">
                            <el-input v-model.trim="submitData.Patient.BedId" :disabled="!submitData.Patient.HospitalId" class="font16blod" placeholder="床号(必填)"></el-input>
                        </div>
                    </li>
                    <li>
                        <p class="font16gray">病人姓名</p>
                        <div class="el_input_box">
                            <el-input v-model.trim="submitData.Patient.PatientName" :disabled="!submitData.Patient.HospitalId" class="font16blod" placeholder="病人姓名(必填)"></el-input>
                        </div>
                    </li>
                    <li>
                        <p class="font16gray">门诊类型</p>
                        <div class="el_input_box">
                            <el-select v-model="submitData.OutpatientType" :disabled="!submitData.Patient.HospitalId" class="font16blod green24x13" placeholder="门诊类型(必填)">
                    ...
                    <li>
                        ...
                        <div class="el_input_box">
                            <el-input v-model.trim="submitData.Patient.SubClinic" :disabled="!submitData.Patient.HospitalId" class="font16blod"></el-input>
                        </div>
                    </li>
                </ul>
                <ul v-if="!submitData.IsBackupPackage">
                    ...
                    <li>
                        ...
                        <div class="el_input_box">
                            <el-date-picker class="font16blod" :editable="false" :clearable="false" v-model="submitData.Patient.SurgicalDate" type="date" placeholder="选择日期" format="yyyy-MM-dd" value-format="yyyy-MM-dd" :disabled="!submitData.Patient.HospitalId"></el-date-picker>
                        </div>
                    </li>
                    <li>
            ...
            <template v-if="GLOBAL.UserInfo.HospitalVersion!='TONGJI'">
                <ul v-if="!submitData.IsBackupPackage">
                    ...
                    <li>
                        ...
                        <div class="el_input_box">
                            <el-input v-model.trim="submitData.Patient.Gender" :disabled="!submitData.Patient.HospitalId" class="font16blod"></el-input>
                        </div>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <div class="el_input_box">
                            <el-date-picker class="font16blod" :editable="false" :clearable="false" v-model="submitData.Patient.AdmissionDate" type="date" placeholder="选择日期" format="yyyy-MM-dd" value-format="yyyy-MM-dd" :disabled="!submitData.Patient.HospitalId"></el-date-picker>
                        </div>
                    </li>
                    <li>
                        <p class="font16gray">使用科室</p>
                        <div class="el_input_box">
                            <el-input v-model.trim="submitData.Patient.Clinic" :disabled="!submitData.Patient.HospitalId" class="font16blod"></el-input>
                        </div>
                    </li>
                    <li>
                        <p class="font16gray">挂号科室</p>
                        <div class="el_input_box">
                            <el-input v-model.trim="submitData.Patient.RegisteredClinic" :disabled="!submitData.Patient.HospitalId" class="font16blod"></el-input>
                        </div>
                    </li>
                    <li>
                        <p class="font16gray">挂号时间</p>
                        <div class="el_input_box">
                            <el-date-picker class="font16blod" :editable="false" :clearable="false" v-model="submitData.Patient.RegisteredDate" type="date" placeholder="选择日期" format="yyyy-MM-dd" value-format="yyyy-MM-dd" :disabled="!submitData.Patient.HospitalId"></el-date-picker>
                        </div>
                    </li>
                </ul>
                <ul v-if="!submitData.IsBackupPackage">
                    ...
                    <li>
                        ...
                        <div class="el_input_box">
                            <el-input v-model.trim="submitData.Patient.SurgicalSite" :disabled="!submitData.Patient.HospitalId" class="font16blod"></el-input>
                        </div>
                    </li>
                    <li>
                        <p class="font16gray">手术间</p>
                    ...
                    <el-table-column label="操作" width="110">
                        <template slot-scope="props">
                            <div class="table_option">
                                <el-button type="primary" class="editThisRow" @click="editThisRow(props.$index)" :disabled="props.row.CanNotBeModified" size="mini">修改</el-button>
                                <el-button class="deleteThisRow" @click="deleteThisRow(props.$index)" :disabled="props.row.CanNotBeModified" size="mini">删除</el-button>
                            </div>
                        </template>
                    </el-table-column>
            ...
            <el-button type="primary" @click="handleAddPackage" style="margin-top:30px;" class="btn120x40">新增</el-button>
        </div>
        <div class="cssd_table_bottom">
            <p>
                <el-button v-if="outerPackageChangeMode" round @click="cancelChange">取消修改</el-button>
                <el-button type="primary" round @click="submitComplete">{{outerPackageChangeMode?'修改完成':'保存'}}</el-button>
            </p>
        </div>
    </div>
    <transition name="fade" enter-active-class="animated fadeIn faster" leave-active-class="animated fadeOut faster">
        <AddPackage v-if="isShowAddPackage" @addPackage-father="addPackage2father" :data="dataToChild" :index="index" :mode="mode" :isBackupPackage="submitData.IsBackupPackage"></AddPackage>
    </transition>
</div>
</template>
