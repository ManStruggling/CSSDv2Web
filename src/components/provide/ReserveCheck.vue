            ...
            <div class="container table_collapse">
              ...
              <el-checkbox-group v-model="item.CheckList" @change="handleCheckedChange">
                <el-collapse accordion>
                  <el-collapse-item
                    v-for="(value,collapseIndex) in item.BookTasks"
                    :key="collapseIndex"
                    :name="collapseIndex+''"
                  >
                    <div slot="title" class="collapseTh">
                      ...
                      <div class="collapseTd">
                        <p>
                          <a
                            @click.stop="editBookTask(value.BookTaskId,item.SubClinicId,item.SubClinicName)"
                          >编辑</a>
                    ...
                    <el-tabs type="card">
                      <el-tab-pane
                        label="无菌物品"
                        v-if="value.Products==''?false:true"
                      ...
                      <el-tab-pane
                        label="一次性物品"
                        v-if="value.DisposableItems==''?false:true"
                        class="table_unExpand"
                      >
