    ...
    <div class="cssd_table_center cssd_totalBar">
            ...
            <ul>
                <li>
                    ...
                    <div class="el_input_box font16blod">
                        <el-date-picker class="font16blod" :editable="false" :clearable="false" v-model="submitData.BookDateTime" type="date" placeholder="选择日期" format="yyyy-MM-dd" value-format="yyyy-MM-dd" :disabled="true"></el-date-picker>
                    </div>
                </li>
                <li>
                    <p class="font16gray">供应室</p>
                    <div class="el_input_box font16blod">
                        <el-select v-model="submitData.BookCssdId" class="green24x13" :disabled="true">
                ...
                <li>
                    ...
                    <div class="el_input_box font16blod">
                        <el-select v-model="submitData.BookSubClinicId" class="green24x13" :disabled="true">
                ...
                <li class="myTextarea">
                    ...
                    <div class="el_input_box font16blod">
                        <el-input class="font16blod" v-model.trim="submitData.Remark" type="textarea" resize="none" placeholder="请输入备注" maxlength="20" show-word-limit :disabled="true"></el-input>
                    </div>
                </li>
            </ul>
            <h3></h3>
        ...
        <div class="cssd_table_bottom">
            ...
            <p>
                ...
                <el-button type="primary" @click="submitComplete">修改完成</el-button>
            </p>
        </div>
    </div>
    <transition name="fade" enter-active-class="animated fadeIn faster" leave-active-class="animated fadeOut faster">
        <ReserveProductList v-if="isShowProductList" @productList-to-father="productListToFather" :cssdId="submitData.BookCssdId"></ReserveProductList>
    </transition>
    <transition name="fade" enter-active-class="animated fadeIn faster" leave-active-class="animated fadeOut faster">
        <DisposableList v-if="isShowDisposableList" @disposableList-to-father="disposableListToFather" :cssdId="submitData.BookCssdId"></DisposableList>
    </transition>
</div>
</template>

<script>
import ReserveProductList from "../apply/ReserveProductList";
import DisposableList from "../apply/DisposableList";
export default {
    data() {
        return {
            tabActiveName: "0",
