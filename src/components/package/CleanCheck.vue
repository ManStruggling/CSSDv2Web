...
<div class="cleanReview">
                ...
                <div class="cssd_table_left">
                    <div class="cssd_talbe_left_menu">
                        <dl class="isActive">
                            ...
                            <dd class="reviewDd" style="display:block;">
                                <el-tabs :tab-position="'left'" activeName="0">
                                    <el-tab-pane v-for="(item,index) in cleanTask.CleanPendingReviewTasks" :key="index" :label="item.CleanBarCode" :name="index+''">
                                        <div class="tab_content">
                                            <div class="checkStatusBox">
                                                <p>清洗审核结果</p>
                                                <el-select v-model="item.CleanReviewResult" filterable allow-create default-first-option class="green24x13">
                        ...
                        <dl>
                            ...
                            <dd class="reviewDd">
                                <el-tabs :tab-position="'left'" activeName="0">
                                    <el-tab-pane v-for="(item,index) in cleanTask.CleanCleaningTasks" :key="index" :label="item.CleanBarCode" :name="index+''">
                                        <div class="tab_content">
                                            <div class="timerBox">
    ...
    <transition name="slide" :enter-active-class="`animated  faster slideInRight`" :leave-active-class="`animated  faster slideOutRight`">
        <CleanFailedPackages v-if="isShowCleanFailedPackages" @cleanFailed-to-father="cleanFailedToFather" :failedCarriers="failedCarrier" :taskId="taskId"></CleanFailedPackages>
    </transition>
</div>
</template>
        ...
        submitCheckResult(index) {
            if (this.cleanTask.CleanPendingReviewTasks[index].CleanReviewResult == 4) {
                if (!this.GLOBAL.VerificationHandle([{
                        val: this.cleanTask.CleanPendingReviewTasks[index].FailedPackageNumber,
                        type: "NumberNotZero",
