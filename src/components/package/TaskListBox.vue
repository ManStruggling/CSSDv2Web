  ...
  <div id="packageTaskListBox">
    <ul>
      <li>
        <h4>包名称</h4>
        <el-tooltip
          :content="submitData.Packages[0].ProductName"
          placement="right"
          :disabled="submitData.Packages[0].ProductName.length<11"
        >
      ...
      <li>
        <h4>所属科室</h4>
        <el-tooltip
          :content="submitData.Packages[0].SubClinicName"
          placement="right"
          :disabled="submitData.Packages[0].SubClinicName.length<11"
        >
...
export default {
  ...
  props: ["data", "origin", "tabIndex", "UserInfo"],
  components: {
    PhotoView
  },
  created() {
