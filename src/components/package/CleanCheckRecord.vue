...
<div class="cssd_box" id="cleanReviewRecords">
                            ...
                            <div class="table_detail">
                                ...
                                <ul>
                                    <li v-for="(selfs,myTableIndex) in props.row.PackageBarCodeDetailList" :key="myTableIndex">
                                        <el-tooltip :content="selfs.ProvideSubClinicName" placement="top-start" :disabled="selfs.ProvideSubClinicName.length<10">
    ...
    <transition name="fade" enter-active-class="animated fadeIn faster" leave-active-class="animated fadeOut faster">
        <!-- 查看不合格网篮 -->
        <LookFailedInstruments v-if="isShowFailedInstruments" :record_id="record_id" @to-father="failedInstruments2father"></LookFailedInstruments>
    </transition>
</div>
</template>
