<template>
<div class="cssd_box" id="instrumentReplenishmentRecord">
    <div class="cssd_title">
        <ul class="cssd_menu">
            <router-link to="/publicModule/instrumentReplenishment" tag="li">
                <p>返回</p>
            </router-link>
        </ul>
        ...
        <el-collapse accordion @change="collapseChange">
            <el-collapse-item v-for="(item,collapseIndex) in recordList" :key="collapseIndex" :name="collapseIndex+''">
                ...
                <el-table :data="item.Packages" :default-expand-all="true">
                    <el-table-column label="器械名称" prop="BarCode" width="240" show-overflow-tooltip></el-table-column>
                    <el-table-column label="丢失数" prop="SubClinic" width="210"></el-table-column>
                    <el-table-column label="本次补货数" prop="SubClinic" width="210"></el-table-column>
