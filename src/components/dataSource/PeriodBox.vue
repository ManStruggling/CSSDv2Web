    ...
    <div class="editContainer">
        <div class="editContent">
            <ul class="clear_float">
                ...
                <li>
                    <p>开始时间</p>
                    <el-time-select placeholder="起始时间" :clearable="false" v-model="editBoxData.StartTime" :picker-options="{
                            start: '00:00',
                            end: '23:59',
                            step: '00:15',
                ...
                <li>
                    <p>结束时间</p>
                    <el-time-select placeholder="结束时间" :clearable="false" v-model="editBoxData.EndTime" :picker-options="{
                            start: '00:00',
                            end: '23:59',
                            step: '00:15',
