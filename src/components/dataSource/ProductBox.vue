      ...
      <div class="editContent EditBoxContentOfProduct table_unExpand">
          ...
          <el-tab-pane label="基本信息" name="0">
            <ul class="clear_float ul_form_style">
              ...
              <li>
                <p>发放供应室</p>
                <el-select
                  v-model="editBoxData.ProvideCssdId"
                  placeholder="请选择(必选)"
                  class="green24x13"
                >
                  <el-option
                    v-for="item in optionCssdList"
                    :key="item.value"
                    :label="item.label"
                    :value="item.value"
                  ></el-option>
              ...
              <li v-if="editBoxData.Type != 82">
                ...
                <el-select v-model="editBoxData.DeviceType" class="green24x13">
                  ...
                  <el-option label="不限制" :value="5"></el-option>
                </el-select>
              </li>
              <li v-if="editBoxData.Type!=85">
                <p>成本价格</p>
          ...
          <el-tab-pane label="包属性" name="1">
            <ul class="clear_float ul_form_style">
              <li v-if="editBoxData.Type==80||editBoxData.Type==82">
                <p>通用包</p>
                <el-select
                  v-model="editBoxData.IsCommonProduct"
                  class="green24x13"
                  @change="commonPackageChange"
                >
            ...
            <ul class="clear_float ul_form_style">
              <li
                v-if="UserInfo.Configuration.IsActiveNotBarCodeProduct&&(editBoxData.Type==80||editBoxData.Type==82)"
                v-show="!editBoxData.IsSingleCarrierProduct"
              >
                <p>计数包</p>
                <el-select
                  v-model="editBoxData.IsNotPrintBarCode"
                  @change="countPackageChange"
                  class="green24x13"
                >
                  <el-option label="是" :value="true"></el-option>
                  <el-option label="否" :value="false"></el-option>
              ...
              <li
                v-if="editBoxData.Type==80||editBoxData.Type==82"
                v-show="editBoxData.IsNotPrintBarCode"
              >
                <p>打印标签</p>
            ...
            <ul class="clear_float ul_form_style">
              <li
                v-if="UserInfo.Configuration.IsActiveNumberProduct&&(editBoxData.Type==80||editBoxData.Type==82)"
                v-show="!editBoxData.IsSingleCarrierProduct"
              >
                <p>个数包</p>
                <el-select
              ...
              <li
                v-if="editBoxData.Type==80||editBoxData.Type==82"
                v-show="editBoxData.IsNumberProduct"
              >
                <p>单包总个数</p>
                <el-input-number
        ...
        >
          ...
          <PhotoView
            ...
            :data="editBoxData.ProductPictures"
                ...
                <el-table-column label="数量" width="210">
                  <template slot-scope="props">
                    <el-input-number
                      ...
                      :controls="false"
                      size="mini"
                      @change="((newValue)=>{talbeNumberChange(newValue,'InstrumentCounts',props.$index)})"
                    ></el-input-number>
                  </template>
                </el-table-column>
                ...
                <el-table-column label="数量" width="210">
                  <template slot-scope="props">
                    <el-input-number
                      ...
                      :controls="false"
                      size="mini"
                      @change="((newValue)=>{talbeNumberChange(newValue,'MaterialCounts',props.$index)})"
                    ></el-input-number>
                  </template>
                </el-table-column>
                <el-table-column label="操作" width="210">
        ...
        if (res.data.Code == 200) {
          ...
          if (this.editBoxData.Id != 0) {
            ...
            for (let i = 0; i < this.optionClinicList.length; i++) {
              for (
                let j = 0;
                j < this.optionClinicList[i].children.length;
                j++
              ) {
                if (
