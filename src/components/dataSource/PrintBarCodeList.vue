...
<div id="barCodeList">
    <div class="barCode_box">
        <div class="container table_unExpand">
            <el-table ref="multipleTable" :data="dataList" tooltip-effect="dark" @selection-change="handleSelectionChange" height="508" :row-key="getRowKeys" @row-click="handleRowClick">
                <el-table-column type="selection" width="130" :reserve-selection="true"></el-table-column>
                <el-table-column v-for="(item,index) in $props.labels" :key="index" :label="item.label" :prop="item.prop"></el-table-column>
