    ...
    <div class="editContainer">
        <div class="editContent">
            <ul class="clear_float">
                <li>
                    <p>设备名称</p>
                    <el-input type="text" placeholder="设备名称(必填)" v-model.trim="editBoxData.Name"></el-input>
                </li>
                <li>
                    <p>设备简码</p>
                ...
                <li>
                    <p>生产日期</p>
                    <el-date-picker :editable="false" :clearable="false" v-model="editBoxData.ProduceDate" type="date" placeholder="选择日期" format="yyyy.MM.dd" value-format="yyyy-MM-dd"></el-date-picker>
                </li>
                <li>
                    <p>所属供应室</p>
                    <el-select v-model="editBoxData.OwnCssdId" placeholder="请选择" class="green24x13">
                        <el-option v-for="item in opetionCssdList" :key="item.value" :label="item.label" :value="item.value"></el-option>
                    </el-select>
                </li>
                <li>
                    <p>总锅次</p>
                    <el-input-number v-model="editBoxData.TotalBatch" :min="1" :max="1000000" :controls="false" label="总锅次" @change="((newValue,oldValue)=>{numberChange(newValue,oldValue,'TotalBatch')})"></el-input-number>
                </li>
                <li>
                    <p>当日锅次</p>
                    <el-input-number v-model="editBoxData.TodayBatch" :min="1" :max="100" :controls="false" label="当日锅次" @change="((newValue,oldValue)=>{numberChange(newValue,oldValue,'TodayBatch')})"></el-input-number>
                </li>
                <li>
                    <p>上次维护日期</p>
                    <el-date-picker :editable="false" :clearable="false" v-model="editBoxData.LastMaintenanceDate" type="date" placeholder="选择日期" format="yyyy.MM.dd" value-format="yyyy-MM-dd"></el-date-picker>
                </li>
                <li>
                    <p>选择设备型号</p>
                    <el-cascader expand-trigger="hover" :options="optionList" v-model="selectedOptions" @change="handleChange" placeholder="设备型号(必选)" class="green24x13"></el-cascader>
                </li>
                <li>
                    <p>是否启用</p>
