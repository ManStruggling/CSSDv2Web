    ...
    <div class="cssd_login_right">
      <dl>
        <dt>
          <p>
            <img
              :src="versionMsg.Configuration.Company?versionMsg.Configuration.Company.Logo:'/images/login_logo.png'"
              alt
            />
          </p>
          <h4>医院消毒供应追溯管理软件</h4>
        ...
        <dd>
          ...
          <el-input
            ...
            @keyup.enter.native="loginToStart"
            placeholder="请输入密码"
          ></el-input>
        </dd>
        <dd>
      ...
      <h5>
        <a href="\Client\CSSDv2Client.rar" download="CSSDv2Client.rar">
          <i class="el-icon-download"></i>下载客户端
        </a>
        <b>{{versionMsg.Configuration.Company?versionMsg.Configuration.Company.Name:'上海倍而纳医疗器械科技有限公司'}}</b>
  ...
  created() {
    ...
    axios({
      ...
      if (res.data.Code == 200) {
        ...
        if (this.versionMsg.Configuration.Company) {
