      ...
      <el-collapse accordion @change="collapseChange">
        ...
        >
          <div slot="title" class="collapseTh">
            ...
            <div class="collapseTd">
              <el-tooltip
                :content="item.BookSubClinic"
                placement="right"
                :disabled="item.BookSubClinic.length<12"
              >
            ...
            <div class="collapseTd">
              <p>
                ...
                <el-button
                  size="mini"
                  @click.stop="cancelReserve(collapseIndex)"
                  :disabled="(UserInfo.JobAndCompetence.includes('271')||UserInfo.JobAndCompetence.includes('000')||UserInfo.JobAndCompetence.includes('200'))&&!item.CanNotBeModified?false:true"
                >{{item.IsCanceled?'已取消':'取消'}}</el-button>
              </p>
            </div>
          </div>
          <el-tabs type="card" v-model="activeName">
            ...
            <el-tab-pane
              label="一次性物品"
              v-if="item.DisposableItems==''?false:true"
              class="table_unExpand"
            >
