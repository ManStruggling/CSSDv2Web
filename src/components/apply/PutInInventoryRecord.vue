      ...
      <el-collapse accordion @change="collapseChange">
        ...
        >
          ...
          <el-table :data="item.Packages" :default-expand-all="true">
            ...
            <el-table-column label="子科室" prop="SubClinicName" width="210"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    //查询
    searchRecordsData() {
      axios({url:`/api/Inbound/InboundRecord/${this.search_date[0]}/${this.search_date[1]}`}).then(res=>{
        let type;
        if(res.data.Code==200){
          type="success";
