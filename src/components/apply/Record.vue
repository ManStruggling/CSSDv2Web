      ...
      <el-collapse accordion @change="collapseChange">
        ...
        >
          <div slot="title" class="collapseTh">
            ...
            <div class="collapseTd">
              <p>
                <el-button size="mini" @click.stop="changeRecord(collapseIndex)" :disabled="(GLOBAL.UserInfo.JobAndCompetence.includes('271')||GLOBAL.UserInfo.JobAndCompetence.includes('000')||GLOBAL.UserInfo.JobAndCompetence.includes('200'))?false:true">修改</el-button>
              </p>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    //查询
    searchRecordsData() {
      this.GLOBAL.searchRecord(this.search_date[0],
        this.search_date[1], this,'/odata/ApplyingRecords','ApplyingDate');
    }
  }
};
</script>
