            ...
            <div class="collapseTd">
              <p>
                <el-button
                  ...
                  :disabled="(UserInfo.JobAndCompetence.includes('121')||UserInfo.JobAndCompetence.includes('000')||UserInfo.JobAndCompetence.includes('100'))&&!item.CanNotBeModified?false:true"
                >修改</el-button>
              </p>
            </div>
          </div>
              ...
              <template slot-scope="props">
                <div class="table_detail">
                  ...
                  <ul>
                    ...
                    >
                      <el-tooltip
                        :content="selfs.ProvideSubClinicName"
                        placement="right"
                        :disabled="selfs.ProvideSubClinicName.length<10"
                      >
...
export default {
  ...
  methods: {
    ...
    collapseChange(index) {
      if (
        index != "" &&
        (this.recordList[index].Carriers == "" ||
          this.recordList[index].Carriers === null)
      ) {
        axios({
    ...
    searchRecordsData() {
      this.GLOBAL.searchRecord(
        `/api/Clean/CleanRecords/${this.search_date[0]}/${this.search_date[1]}`,
        this
      );
    }
  },
