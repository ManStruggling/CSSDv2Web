            ...
            <div class="collapseTd">
              <p>
                <el-button
                  ...
                  :disabled="UserInfo.JobAndCompetence.includes('161')||UserInfo.JobAndCompetence.includes('000')||UserInfo.JobAndCompetence.includes('100')?false:true"
                >修改</el-button>
              </p>
            </div>
          </div>
  ...
  methods: {
    ...
    searchRecordsData() {
      this.GLOBAL.searchRecord(
        `/api/Inventory/DisposableProductInboundRecord/${this.search_date[0]}/${this.search_date[1]}`,
        this
      );
    }
  }
