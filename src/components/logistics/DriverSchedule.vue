        ...
        <div class="table_box">
            <ul>
                <li>
                    ...
                    <div class="el_input_box">
                        <el-select v-model="submitData.ScheduleCssdId" class="green24x13" placeholder="供应室(必填)">
                            <el-option v-for="(item,index) in data.Cssds" :key="index" :label="item.CssdName" :value="item.ScheduleCssdId"></el-option>
                        </el-select>
                    </div>
                </li>
                <li>
                ...
                <li>
                    ...
                    <div class="el_input_box">
                        <el-date-picker v-model="submitData.PlanDate" type="date" :clearable="false" placeholder="选择日期(必填)" value-format="yyyy-MM-dd"></el-date-picker>
                    </div>
                </li>
                <li>
                    <p class="font16gray">开始时间</p>
                    <div class="el_input_box">
                        <el-time-select placeholder="开始时间(必填)" v-model="submitData.StartTime" @change="startTimeChange" :picker-options="{
                  start: '06:00',
                  step: '00:15',
                  end: '23:30'
                }"></el-time-select>
                ...
                <li>
                    ...
                    <div class="el_input_box">
                        <el-time-select placeholder="结束时间(必填)" v-model="submitData.EndTime" :picker-options="{
                  start: '06:00',
                  step: '00:15',
                  end: '23:30',
                ...
                <li>
                    ...
                    <div class="el_input_box">
                        <el-select v-model="submitData.LogisticsCarId" class="green24x13" placeholder="选择车辆(必填)">
                            <el-option v-for="(item,index) in data.Cars" :key="index" :label="item.LogisticsCarName" :value="item.LogisticsCarId"></el-option>
                        </el-select>
                    </div>
                </li>
                <li>
                    ...
                    <div class="el_input_box">
                        <el-select v-model="submitData.DriverId" class="green24x13" placeholder="选择司机(必填)" @change="driverChange">
                            <el-option v-for="(item,index) in data.Drivers" :key="index" :label="item.DriverName" :value="item.DriverId"></el-option>
                        </el-select>
                    </div>
                </li>
                <li>
                    ...
                    <div class="el_input_box">
                        <el-select v-model="submitData.HelperId" class="green24x13" placeholder="选择副手" @change="helperChange">
                            <el-option v-for="(item,index) in data.Drivers" :key="index" :label="item.DriverName" :value="item.DriverId"></el-option>
                        </el-select>
                    </div>
                </li>
