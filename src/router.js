...
const router = new Router({
  ...
  routes: [
    ...
    },
    {
      ...
      name: "dataSource",
      meta: { index: 1 },
      component: () => import("./components/dataSource/Basic"),
      children: [
        {
          path: "/dataSource/device/:Type",
          name: "device",
          component: () => import("./components/dataSource/Device"),
        },
        {
          path: "/dataSource/instrument",
          name: "instrument",
          component: () => import("./components/dataSource/Instrument"),
        },
        {
          path: "/dataSource/producer/:Type",
          name: "producer",
          component: () => import("./components/dataSource/Producer"),
        },
        {
          path: "/dataSource/product/:Type",
          name: "product",
          component: () => import("./components/dataSource/Product"),
        },
        {
          path: "/dataSource/supplier/:Type",
          name: "supplier",
          component: () => import("./components/dataSource/Supplier"),
        },
        {
          path: "/dataSource/material",
          name: "material",
          component: () => import("./components/dataSource/Material"),
        },
        {
          path: "/dataSource/carrier/:Type",
          name: "carrier",
          component: () => import("./components/dataSource/Carrier"),
        },
        {
          path: "/dataSource/car/:Type",
          name: "car",
          component: () => import("./components/dataSource/Car"),
        },
        {
          path: "/dataSource/period/:Type",
          name: "period",
          component: () => import("./components/dataSource/Period"),
        },
        {
          path: "/dataSource/externalPackage",
          name: "externalPackage",
          component: () => import("./components/dataSource/ExternalPackage"),
        },
        {
          path: "/dataSource/clinic",
          name: "clinic",
          component: () => import("./components/dataSource/Clinic"),
        },
        {
          path: "/dataSource/staff",
          name: "staff",
          component: () => import("./components/dataSource/Staff"),
        },
        {
          path: "/dataSource/logisticsStaff",
          name: "logisticsStaff",
          component: () => import("./components/dataSource/LogisticsStaff"),
        },
        {
          path: "/dataSource/disposable",
          name: "disposable",
          component: () => import("./components/dataSource/Disposable"),
        },
        {
          path: "/dataSource/failedCause",
          name: "failedCause",
          component: () => import("./components/dataSource/FailedCause"),
        },
        {
          path: "/dataSource/workArea",
          name: "workArea",
          component: () => import("./components/dataSource/WorkArea"),
        },
        {
          path: "/dataSource/consumableProduct",
          name: "/dataSource/consumableProduct",
          component: () => import("./components/dataSource/ConsumableProduct"),
        },
        {
          path: "/dataSource/receiveDepartment",
          name: "receiveDepartment",
          component: () => import("./components/dataSource/ReceiveDepartment"),
        },
      ],
    },
    {
      path: "/recovery",
      name: "recovery",
      component: () => import("./components/recovery/Basic"),
      children: [
        {
          ...
          component: () => import("./components/recovery/Registration"),
        },
        {
          ...
          component: () => import("./components/recovery/Record"),
        },
        {
    ...
    },
    {
      path: "/outerPackage",
      name: "outerPackage",
      component: () => import("./components/outerPackage/Basic"),
      children: [
        {
          ...
          component: () => import("./components/outerPackage/Registration"),
        },
        {
          ...
          component: () => import("./components/outerPackage/Record"),
        },
      ],
    },
    {
      path: "/clean",
      name: "clean",
      component: () => import("./components/clean/Basic"),
      children: [
        {
          path: "/clean/select",
          name: "cleanSelect",
          ...
          component: () => import("./components/clean/CleanSelect"),
        },
        {
          ...
          component: () => import("./components/clean/Registration"),
        },
        {
          path: "/clean/record",
          name: "cleanRecord",
          ...
          component: () => import("./components/clean/Record"),
        },
      ],
    },
    {
      path: "/package",
      name: "package",
      component: () => import("./components/package/Basic"),
      children: [
        {
          ...
          component: () => import("./components/package/CleanCheck"),
        },
        {
          ...
          component: () => import("./components/package/CleanCheckRecord"),
        },
        {
          ...
          component: () => import("./components/package/TaskList"),
        },
        {
          ...
          component: () => import("./components/package/TaskRecord"),
        },
      ],
    },
    {
      path: "/sterilize",
      name: "sterilize",
      component: () => import("./components/sterilize/Basic"),
      children: [
        {
          ...
          component: () => import("./components/sterilize/Select"),
        },
        {
          ...
          component: () => import("./components/sterilize/Ready"),
        },
        {
        ...
        },
        {
          ...
          component: () => import("./components/sterilize/ReadyRecord"),
        },
        {
          ...
          component: () => import("./components/sterilize/Registration"),
        },
        {
          ...
          component: () => import("./components/sterilize/Record"),
        },
        {
          ...
          component: () => import("./components/sterilize/Check"),
        },
        {
          ...
          component: () => import("./components/sterilize/MissingPackageAdd"),
        },
        {
          ...
          component: () => import("./components/sterilize/CheckRecord"),
        },
        {
          ...
          component: () => import("./components/sterilize/Recall"),
        },
        {
          ...
          component: () => import("./components/sterilize/RecallRecord"),
        },
      ],
    },
    {
      path: "/inventory",
      name: "inventory",
      component: () => import("./components/inventory/Basic"),
      children: [
        {
          ...
          component: () => import("./components/inventory/HasBarCode"),
        },
        {
          ...
          component: () => import("./components/inventory/NoBarCode"),
        },
        {
          ...
          component: () => import("./components/inventory/InboundRecord"),
        },
        {
          ...
          component: () => import("./components/inventory/OutboundRecord"),
        },
        {
    ...
    },
    {
      ...
      component: () => import("./components/inventoryCounting/Basic"),
      children: [
        {
        ...
        },
        {
          ...
          component: () => import("./components/inventoryCounting/Record.vue"),
        },
        {
    ...
    },
    {
      path: "/track",
      name: "track",
      component: () => import("./components/track/Basic"),
      children: [
        {
          path: "/track/patient",
          name: "trackPatient",
          ...
          component: () => import("./components/track/PatientTrack"),
        },
        {
          path: "/track/opration",
          name: "trackOpration",
          ...
          component: () => import("./components/track/OprationalLog"),
        },
        {
          path: "/track/package",
          name: "trackPackage",
          ...
          component: () => import("./components/track/PackageTrack"),
        },
        {
          ...
          component: () => import("./components/track/DisposableProduct"),
        },
        {
          ...
          component: () => import("./components/track/SingleRecall"),
        },
      ],
    },
    {
      path: "/provide",
      name: "provide",
      component: () => import("./components/provide/Basic"),
      children: [
        {
          ...
          component: () => import("./components/provide/Registration"),
        },
        {
          path: "/provide/record",
          name: "provideRecord",
          ...
          component: () => import("./components/provide/Record"),
        },
        {
          ...
          component: () => import("./components/provide/BorrowRegistration"),
        },
        {
          ...
          component: () => import("./components/provide/BorrowRecord"),
        },
        {
          ...
          component: () => import("./components/provide/ReserveCheck"),
        },
        {
          ...
          component: () => import("./components/provide/ReserveCheckRecord"),
        },
        {
          ...
          component: () => import("./components/apply/ReserveProduct"),
        },
      ],
    },
    {
      path: "/logistics",
      name: "logistics",
      component: () => import("./components/logistics/Basic"),
      children: [
        {
        ...
        },
        {
          ...
          component: () => import("./components/logistics/DriverSchedule"),
        },
        {
          ...
          component: () => import("./components/logistics/Record"),
        },
        {
          path: "/logistics/look",
          name: "logisticsLook",
          ...
          component: () => import("./components/logistics/ScheduleSearch"),
        },
      ],
    },
    {
      path: "/apply",
      name: "apply",
      component: () => import("./components/apply/Basic"),
      children: [
        {
          ...
          component: () => import("./components/apply/Registration"),
        },
        {
          path: "/apply/record",
          name: "applyRecord",
          ...
          component: () => import("./components/apply/Record"),
        },
        {
        ...
        },
        {
          ...
          component: () => import("./components/apply/UnqualifiedRecord"),
        },
        {
          ...
          component: () => import("./components/apply/PutInInventory"),
        },
        {
          ...
          component: () => import("./components/apply/PutInInventoryRecord"),
        },
        {
          path: "/apply/reserve",
          name: "applyReserve",
        ...
        },
        {
          ...
          component: () => import("./components/apply/ReserveProductRecord"),
        },
        {
          ...
          component: () => import("./components/apply/RecycleInClinic.vue"),
        },
      ],
    },
    {
    ...
    },
    {
      ...
      component: () => import("./components/temp/test"),
    },
    {
      path: "/test2",
      name: "test2",
      ...
      component: () => import("./components/temp/test2"),
    },
    {
      path: "/management",
      name: "management",
      ...
      component: () => import("./components/management/ControlPlat"),
      children: [
        {
          ...
          component: () => import("./components/management/Desktop"),
        },
        {
          path: "/management/reportForm",
          name: "managementReportForm",
          component: () => import("./components/management/ReportForm"),
        },
        {
          path: "/management/viewReportForm",
          name: "managementViewReportForm",
          component: () => import("./components/management/ViewReportForm"),
        },
        {
          path: "/management/configure",
          name: "managementConfigure",
          component: () => import("./components/management/Configure"),
        },
        {
          path: "/management/schedulingWorkSheet",
          name: "schedulingWorkSheet",
          component: () => import("./components/management/WorkSheetList"),
        },
        {
          path: "/management/dailyWorkSheet",
          name: "dailyWorkSheet",
          component: () => import("./components/management/DailyWorkSheet"),
        },
        {
          path: "/management/vacationSchedule",
          name: "vacationSchedule",
          component: () => import("./components/management/VacationSchedule"),
        },
        {
        ...
        },
        {
          ...
          name: "workLoad",
          component: () => import("./components/management/WorkLoad"),
        },
        {
          path: "/management/statistics",
          name: "statistics",
          component: () =>
            import("./components/management/QualifiedRateStatistics"),
        },
      ],
    },
    {
      path: "/publicModule",
      name: "publicModule",
      component: () => import("./components/publicModule/Basic"),
      children: [
        {
          ...
          component: () => import("./components/publicModule/Reprint"),
        },
        {
    ...
    },
    {
      path: "/expendables",
      name: "expendables",
      component: () => import("./components/expendablesManagement/Basic"),
      children: [
        {
    ...
    },
    {
      path: "/help",
      name: "help",
      component: () => import("./components/help/Basic"),
      children: [
        {
          path: "/help/userManual",
          name: "helpUserManual",
          component: () => import("./components/help/UserManual"),
        },
      ],
    },
    {
